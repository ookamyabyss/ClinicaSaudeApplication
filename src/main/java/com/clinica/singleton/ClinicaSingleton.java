...
public class ClinicaSingleton {
    ...
    private void inicializarProcedimentos() {
        ...
        if (aceitaParticular) {
            adicionarProcedimento(
                ProcedimentoFactory.criarProcedimento(Especialidade.PEDIATRIA, "Consulta Particular Pediatria", 300.00));
            adicionarProcedimento(
                ProcedimentoFactory.criarProcedimento(Especialidade.DERMATOLOGIA, "Consulta Particular Dermatologia", 350.00));
            adicionarProcedimento(
                ProcedimentoFactory.criarProcedimento(Especialidade.ENDOCRINOLOGIA, "Consulta Particular Endocrinologia", 400.00));
        }
    }
